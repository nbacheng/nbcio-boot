...
public class WebSocket {
    ...
    public void pushMessage(String userId, String message) {
        ...
        if (session != null && session.isOpen()) {
            try {
                //update-begin-author:taoyan date:20211012 for: websocket报错 https://gitee.com/jeecg/nbcio-boot/issues/I4C0MU
                synchronized (session){
                    log.info("【websocket消息】 单点消息:" + message);
                    session.getBasicRemote().sendText(message);
                }
                //update-end-author:taoyan date:20211012 for: websocket报错 https://gitee.com/jeecg/nbcio-boot/issues/I4C0MU
            } catch (Exception e) {
                e.printStackTrace();
            }
        }

...
public interface SysUserMapper extends BaseMapper<SysUser> {
	 ...
	 * @return
	 */
	List<SysUserNameVo> getRealNameByNames(@Param("userNames")List<String> userNames); // add by nbacheng
	SysUserNameVo getRealNameByName(@Param("userName")String userName); // add by nbacheng

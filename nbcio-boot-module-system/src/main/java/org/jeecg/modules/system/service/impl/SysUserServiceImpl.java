...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	// add by nbacheng 多个username获取realname
	@Override
	public List<SysUserNameVo> getRealNameByNames(List<String> userNames) {
		// TODO Auto-generated method stub
		List<SysUserNameVo> list = userMapper.getRealNameByNames(userNames);

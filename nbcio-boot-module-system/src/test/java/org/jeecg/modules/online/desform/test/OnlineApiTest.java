...
import org.jeecg.NbcioSystemApplication;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,classes = NbcioSystemApplication.class)
...
public class OnlineApiTest {
     ...
     * 测试地址：实际使用时替换成你自己的地址
     */
    private final String BASE_URL = "http://localhost:8080/nbcio-boot/online/cgform/api/";
